...
"documentation/dcpowersupply.mdx": {
	id: "documentation/dcpowersupply.mdx";
  slug: "documentation/dcpowersupply";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
...
"documentation/mobilephonetrainerkit.mdx": {
	id: "documentation/mobilephonetrainerkit.mdx";
  slug: "documentation/mobilephonetrainerkit";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
...
"documentation/opapmtrainerkit.mdx": {
	id: "documentation/opapmtrainerkit.mdx";
  slug: "documentation/opapmtrainerkit";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
...
"documentation/plctrainerkit.mdx": {
	id: "documentation/plctrainerkit.mdx";
  slug: "documentation/plctrainerkit";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
...
"documentation/sensortrainerkit.mdx": {
	id: "documentation/sensortrainerkit.mdx";
  slug: "documentation/sensortrainerkit";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
"documentation/seriessignalgenerator.mdx": {
	id: "documentation/seriessignalgenerator.mdx";
  slug: "documentation/seriessignalgenerator";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
"documentation/solar.mdx": {
	id: "documentation/solar.mdx";
  slug: "documentation/solar";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
...
"documentation/upstrainer.mdx": {
	id: "documentation/upstrainer.mdx";
  slug: "documentation/upstrainer";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
...
"posts": {
"astro-components copy 1.md": {
	id: "astro-components copy 1.md";
  slug: "dso1";
  body: string;
  collection: "posts";
...
"astro-components copy 18.md": {
	id: "astro-components copy 18.md";
  slug: "solar";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
"astro-components copy 19.md": {
	id: "astro-components copy 19.md";
  slug: "upstrainer";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
...
"astro-components copy 20.md": {
	id: "astro-components copy 20.md";
  slug: "seriessignalgenerator";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
"astro-components copy 21.md": {
	id: "astro-components copy 21.md";
  slug: "mobilephonetrainerkit";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
"astro-components copy 22.md": {
	id: "astro-components copy 22.md";
  slug: "opapmtrainerkit";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
"astro-components copy 23.md": {
	id: "astro-components copy 23.md";
  slug: "sensortrainerkit";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
"astro-components copy 24.md": {
	id: "astro-components copy 24.md";
  slug: "dcpowersupply";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
"astro-components copy 25.md": {
	id: "astro-components copy 25.md";
  slug: "plctrainerkit";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
